<template>
    <el-container class="panel">
        ...
        <el-main>
                ...
                <el-row :gutter="20">
                    <el-col style="padding-bottom: 15px;" :xs="24" :sm="12" :md="8" :lg="6" :xl="4" v-for="(account, index) in accounts" :key="index">
                        <el-card :class="{ 'busy': account.auto === '1' }">
                            <div slot="header" class="clearfix">
                                <span>{{account.type}}账号 {{ index + 1 }}</span>
                                <el-tag :type="account.sessionToken ==='' ? 'success' : 'danger'" size="small"
                                    style="float: right;">
