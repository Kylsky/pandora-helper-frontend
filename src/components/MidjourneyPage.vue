<template>
    <div class="min-h-screen flex justify-center items-center p-5 bg-gradient-to-br from-[#8EC5FC] to-[#E0C3FC]">
        <div class="bg-white rounded-xl shadow-lg p-10 w-full max-w-md transform transition-transform duration-300 hover:-translate-y-2">
            ...
            <div class="text-center">
                ...
                <button type="button" @click="reset()"
                    class="w-full py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-lg font-medium transition duration-300 hover:border-[#6A93CB] hover:text-[#6A93CB]">
                    重置密码
                </button>
            </div>
            ...
            <div class="mt-6 text-center">
                <div class="flex items-center justify-center gap-1.5 flex-wrap">
                    <a 
                        ...
                        target="_blank"
                        class="text-xs text-gray-600 hover:text-[#6A93CB] transition duration-300 flex items-center"
                    >
